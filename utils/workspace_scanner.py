...
# -*- coding: utf-8 -*-
"""
Module de scan pour le mode WORKSPACE (dossier unique)
"""
...
class WorkspaceScanner:
    """Classe pour scanner et analyser les projets Cubase en mode WORKSPACE (dossier unique)"""
    def __init__(self):
    ...
    def scan_directory(self, root_dir):
        """
        Parcours récursif d'un dossier unique pour trouver les projets Cubase
        """
